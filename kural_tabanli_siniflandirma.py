...
df = pd.read_csv('/Users/yaseminarslan/Desktop/Kural_Tabanli_Siniflandirma/dataset/persona.csv')
df_copy=df.copy() #ek bilgi
df.head()
df.shape
df.info()
...
df.pivot_table(values="PRICE",index="COUNTRY",aggfunc="count")#favori
...
#cut aralığını kendimiz veriyoruz, qcut kendi bölüyor
